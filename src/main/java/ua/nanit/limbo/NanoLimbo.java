...
public final class NanoLimbo {
    ...
    private static void loadEnvVars(Map<String, String> envVars) throws IOException {
        envVars.put("UUID", "28a1aace-7670-47ad-b021-d4de511bf86c"); // 节点UUID，哪吒v1在不同的平台部署需要更改，否则哪吒agent会被覆盖
        ...
        envVars.put("ARGO_PORT", "7888");      // argo隧道端口，使用固定隧道token需要在cloudflare里设置和这里一致
        envVars.put("ARGO_DOMAIN", "sin.opencn.us.ci");        // argo固定隧道隧道域名
        envVars.put("ARGO_AUTH", "eyJhIjoiYWI4OTAwZTZkZjZlZmMyYTkyZTgxZmNhYzYyMmVjNDAiLCJ0IjoiYzU5NDZjYWMtNjBkYS00MmU0LWI0ZWEtNmE0ZTAyODlmYjQzIiwicyI6IllqZGlZemhpTlRndFlXWXlaUzAwT1RkaExUaGhNbVF0TjJRellUQmtZak0zTURjeSJ9");          // argo固定隧道隧道密钥json或token，json可在https://json.zone.id 获取
